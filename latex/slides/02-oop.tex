...
\begin{frame}[fragile]{Another for example}
	\begin{lstlisting}
...
\begin{frame}[fragile]{Exercises}
	\textbf{1. Display the n terms of odd natural number.}
	\begin{example}	 	
	Input: 10, Output: 1, 3, 5, 7, 9
	\end{example}
	
	\textbf{2. Find the sum and average of 3 numbers.}
	\begin{example}	
	Input: 6, 4, 3 Output: 13 and 4,3
	\end{example}	
	
	\textbf{3. Find the smallest number among three numbers.}
	\begin{example}	
	Input: 6, 4, 3 Output: 3 
	\end{example}
	
\end{frame}

\begin{frame}[fragile]{Adv. Exercises}
	\textbf{4. Display the pattern like a diamond.}
	\begin{example}	
	\begin{verbatim}	
	      *                                                                          
     ***                                                                         
...
\begin{frame}[fragile]{Adv. Exercise}
	\textbf{5. Find all primes up to n.}
	\begin{example}	
